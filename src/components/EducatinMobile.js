...
import "./css/MobileEducation.scss";

const EducatinMobile = () => {
  return (
    <div>
      <div className="MobileEducation">
                ...
                <div className="Educa">
                  <p>
                    ...
                    <h7>
                      ...
                      Computer Science, I have delved deep into various aspects
                      of the field, acquiring in-depth knowledge and expertise.
                      I am eager to leverage this depth of knowledge to make
                      significant contributions in the field of computer
                      science."
                    </h7>
                  </p>
                </div>
                ...
                <div className="Educa">
                  <p>
                    ...
                    <h7>
                      ...
                      practical exposure has deepened my understanding of
                      software development methodologies and refined my
                      technical skills.
                    </h7>
                  </p>
                </div>
                ...
                <div className="Educa">
                  <p>
                    ...
                    <h7>
                      ...
                      Enriching my skill set for future endeavors in this
                      field."
                    </h7>
                  </p>
                </div>
                ...
                <div className="Educa">
                  <p>
                    ...
                    <h7>
                      ...
                      in Cyber Security, gaining valuable knowledge and
                      practical experience in the field. Acquired skills in
                      cyber security practices and procedures, contributing
                      effectively to the team's objectives.
                    </h7>
                  </p>
                </div>
              </li>
